#
#  Be sure to run `pod spec lint SNTool.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/snlo/SNTool.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "SNTool/SNTool/*.{h,m}"
  ...
  s.resources = 'SNTool/SNTool/SNTool.bundle'
