...
static void sn_injectConcreteProtocol (Protocol *protocol, Class containerClass, Class class) {
...
BOOL sn_addConcreteProtocol (Protocol *protocol, Class containerClass) {
    return sn_loadSpecialProtocol(protocol, ^(Class destinationClass){
        sn_injectConcreteProtocol(protocol, containerClass, destinationClass);
    });
}

void sn_loadConcreteProtocol (Protocol *protocol) {
    sn_specialProtocolReadyForInjection(protocol);
}
