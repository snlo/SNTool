...
#define safecategory(CLASS, CATEGORY) \
    ...
    static void sn_ ## CLASS ## _ ## CATEGORY ## _inject (void) { \
        /*
         ...
         * (using sn_safeCategoryFailed)
         */ \
        if (!sn_loadSafeCategory(methodContainer_, targetClass_)) {\
            sn_safeCategoryFailed(CLASS, CATEGORY); \
        } \
    }
...
// if this is a debug build...
    ...
    #define sn_safeCategoryFailed(CLASS, CATEGORY) \
        do { \
